...
import com.example.letrongtin.mywallpaper.activity.ListGIFWallpaperActivity;
...
public class ExploreFragment extends Fragment {
    ...
    public ExploreFragment() {
        ...
        explore = database.getReference(Common.STR_EXPLORE);

        options = new FirebaseRecyclerOptions.Builder<Category>()
                .setQuery(explore, Category.class)
                .build();
            ...
            protected void onBindViewHolder(@NonNull final CategoryViewHolder holder, int position, @NonNull final Category model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        ...
                        Intent listWallpaperIntent = new Intent(getActivity(), ListGIFWallpaperActivity.class);
